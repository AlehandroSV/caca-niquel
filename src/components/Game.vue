  ...
  <div class="flex flex-col justify-center items-center mt-8 select-none">
    ...
    <div class="flex gap-2 mt-4">
      <label class="relative inline-flex items-center cursor-pointer">
        ...
        />
        <div
          class="w-11 h-6 bg-gray-400 rounded-full peer peer-checked:after:translate-x-full fter:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-600 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-500"
        ></div>
      </label>
      <label for="som" class="cursor-pointer"
